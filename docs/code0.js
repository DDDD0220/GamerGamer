...
gdjs.MainCode.GDNewBitmapTextObjects3= [];
gdjs.MainCode.GDNewBitmapTextObjects4= [];
gdjs.MainCode.GDNewBitmapTextObjects5= [];
gdjs.MainCode.GDkaeyasaysObjects1= [];
gdjs.MainCode.GDkaeyasaysObjects2= [];
gdjs.MainCode.GDkaeyasaysObjects3= [];
gdjs.MainCode.GDkaeyasaysObjects4= [];
gdjs.MainCode.GDkaeyasaysObjects5= [];
...
{gdjs.evtTools.sound.playSound(runtimeScene, "y2mate.com - Genshin Impact Original Soundtrack Against All Odds.mp3", true, 80, 1);
}}
...
gdjs.copyArray(runtimeScene.getObjects("Clouds"), gdjs.MainCode.GDCloudsObjects1);
...
}{for(var i = 0, len = gdjs.MainCode.GDCloudsObjects1.length ;i < len;++i) {
    gdjs.MainCode.GDCloudsObjects1[i].setXOffset(gdjs.evtTools.camera.getCameraX(runtimeScene, "", 0) * 1.5);
}
}}
...
};gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDGrassParticleObjects1Objects = Hashtable.newFrom({"GrassParticle": gdjs.MainCode.GDGrassParticleObjects1});gdjs.MainCode.eventsList6 = function(runtimeScene) {
...
gdjs.MainCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9635516);
}
}}
...
{
{gdjs.MainCode.conditionTrue_1 = gdjs.MainCode.condition1IsTrue_0;
gdjs.MainCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10733156);
}
}}
if (gdjs.MainCode.condition1IsTrue_0.val) {
/* Reuse gdjs.MainCode.GDPlayerObjects2 */
...
{
{gdjs.MainCode.conditionTrue_1 = gdjs.MainCode.condition1IsTrue_0;
gdjs.MainCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10964972);
}
}}
if (gdjs.MainCode.condition1IsTrue_0.val) {
/* Reuse gdjs.MainCode.GDPlayerObjects2 */
...
{
{gdjs.MainCode.conditionTrue_1 = gdjs.MainCode.condition1IsTrue_0;
gdjs.MainCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10473220);
}
}}
if (gdjs.MainCode.condition1IsTrue_0.val) {
...
};gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.MainCode.GDPlayerObjects1});gdjs.MainCode.eventsList9 = function(runtimeScene) {
...
};gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDPlayerObjects2Objects = Hashtable.newFrom({"Player": gdjs.MainCode.GDPlayerObjects2});gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDFlyObjects2Objects = Hashtable.newFrom({"Fly": gdjs.MainCode.GDFlyObjects2});gdjs.MainCode.eventsList13 = function(runtimeScene) {
...
{
{gdjs.MainCode.conditionTrue_1 = gdjs.MainCode.condition0IsTrue_0;
gdjs.MainCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(10636684);
}
}if (gdjs.MainCode.condition0IsTrue_0.val) {
gdjs.copyArray(gdjs.MainCode.GDFlyObjects2, gdjs.MainCode.GDFlyObjects3);
...
};gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDEndScreenRetryTextObjects1Objects = Hashtable.newFrom({"EndScreenRetryText": gdjs.MainCode.GDEndScreenRetryTextObjects1});gdjs.MainCode.eventsList18 = function(runtimeScene) {
...
gdjs.MainCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9619076);
}
}}
}
}
...
};gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDPlayerObjects1Objects = Hashtable.newFrom({"Player": gdjs.MainCode.GDPlayerObjects1});gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDCheckpointObjects1Objects = Hashtable.newFrom({"Checkpoint": gdjs.MainCode.GDCheckpointObjects1});gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDCheckpointObjects2Objects = Hashtable.newFrom({"Checkpoint": gdjs.MainCode.GDCheckpointObjects2});gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDCheckpointObjects1Objects = Hashtable.newFrom({"Checkpoint": gdjs.MainCode.GDCheckpointObjects1});gdjs.MainCode.eventsList19 = function(runtimeScene) {

{

gdjs.copyArray(gdjs.MainCode.GDCheckpointObjects1, gdjs.MainCode.GDCheckpointObjects2);


gdjs.MainCode.condition0IsTrue_0.val = false;
{
gdjs.MainCode.condition0IsTrue_0.val = gdjs.evtTools.object.pickAllObjects(runtimeScene, gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDCheckpointObjects2Objects);
}if (gdjs.MainCode.condition0IsTrue_0.val) {
/* Reuse gdjs.MainCode.GDCheckpointObjects2 */
{for(var i = 0, len = gdjs.MainCode.GDCheckpointObjects2.length ;i < len;++i) {
    gdjs.MainCode.GDCheckpointObjects2[i].getBehavior("Checkpoint").SetActivated(false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.MainCode.GDCheckpointObjects2.length ;i < len;++i) {
    gdjs.MainCode.GDCheckpointObjects2[i].setEffectDoubleParameter("Gray", "saturation", 0);
}
}}
...
{
/* Reuse gdjs.MainCode.GDCheckpointObjects1 */
/* Reuse gdjs.MainCode.GDPlayerObjects1 */
{for(var i = 0, len = gdjs.MainCode.GDPlayerObjects1.length ;i < len;++i) {
    gdjs.MainCode.GDPlayerObjects1[i].getBehavior("CheckpointPlayer").ActivateCheckpoint(gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDCheckpointObjects1Objects, "Checkpoint", true, false, (typeof eventsFunctionContext !== 'undefined' ? eventsFunctionContext : undefined));
}
}{for(var i = 0, len = gdjs.MainCode.GDCheckpointObjects1.length ;i < len;++i) {
    gdjs.MainCode.GDCheckpointObjects1[i].setEffectDoubleParameter("Gray", "saturation", 1);
}
}}
...
gdjs.copyArray(runtimeScene.getObjects("Checkpoint"), gdjs.MainCode.GDCheckpointObjects1);
gdjs.copyArray(runtimeScene.getObjects("Player"), gdjs.MainCode.GDPlayerObjects1);

gdjs.MainCode.condition0IsTrue_0.val = false;
gdjs.MainCode.condition1IsTrue_0.val = false;
{
gdjs.MainCode.condition0IsTrue_0.val = gdjs.evtTools.object.hitBoxesCollisionTest(gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDPlayerObjects1Objects, gdjs.MainCode.mapOfGDgdjs_46MainCode_46GDCheckpointObjects1Objects, false, runtimeScene, false);
}if ( gdjs.MainCode.condition0IsTrue_0.val ) {
{
{gdjs.MainCode.conditionTrue_1 = gdjs.MainCode.condition1IsTrue_0;
gdjs.MainCode.conditionTrue_1.val = runtimeScene.getOnceTriggers().triggerOnce(9621356);
}
}}
if (gdjs.MainCode.condition1IsTrue_0.val) {
...
gdjs.copyArray(runtimeScene.getObjects("kaeyasays"), gdjs.MainCode.GDkaeyasaysObjects2);
{for(var i = 0, len = gdjs.MainCode.GDkaeyasaysObjects2.length ;i < len;++i) {
    gdjs.MainCode.GDkaeyasaysObjects2[i].hide();
}
}}
...
{
for(var i = 0, k = 0, l = gdjs.MainCode.GDPlayerObjects2.length;i<l;++i) {
    if ( gdjs.MainCode.GDPlayerObjects2[i].getBehavior("PlatformerObject").isOnLadder() ) {
        gdjs.MainCode.condition0IsTrue_0.val = true;
        gdjs.MainCode.GDPlayerObjects2[k] = gdjs.MainCode.GDPlayerObjects2[i];
        ++k;
    }
...
gdjs.copyArray(runtimeScene.getObjects("kaeyasays"), gdjs.MainCode.GDkaeyasaysObjects2);
{for(var i = 0, len = gdjs.MainCode.GDkaeyasaysObjects2.length ;i < len;++i) {
    gdjs.MainCode.GDkaeyasaysObjects2[i].hide(false);
}
}}
...
{
for(var i = 0, k = 0, l = gdjs.MainCode.GDPlayerObjects1.length;i<l;++i) {
    if ( gdjs.MainCode.GDPlayerObjects1[i].getBehavior("PlatformerObject").isMovingEvenALittle() ) {
        gdjs.MainCode.condition0IsTrue_0.val = true;
        gdjs.MainCode.GDPlayerObjects1[k] = gdjs.MainCode.GDPlayerObjects1[i];
        ++k;
    }
...
gdjs.MainCode.GDPlayerObjects1.length = k;}if (gdjs.MainCode.condition0IsTrue_0.val) {
gdjs.copyArray(runtimeScene.getObjects("kaeyasays"), gdjs.MainCode.GDkaeyasaysObjects1);
{for(var i = 0, len = gdjs.MainCode.GDkaeyasaysObjects1.length ;i < len;++i) {
    gdjs.MainCode.GDkaeyasaysObjects1[i].hide();
}
}}
...
gdjs.MainCode.GDNewBitmapTextObjects3.length = 0;
gdjs.MainCode.GDNewBitmapTextObjects4.length = 0;
gdjs.MainCode.GDNewBitmapTextObjects5.length = 0;
gdjs.MainCode.GDkaeyasaysObjects1.length = 0;
gdjs.MainCode.GDkaeyasaysObjects2.length = 0;
gdjs.MainCode.GDkaeyasaysObjects3.length = 0;
gdjs.MainCode.GDkaeyasaysObjects4.length = 0;
gdjs.MainCode.GDkaeyasaysObjects5.length = 0;
